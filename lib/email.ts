...
const FROM_EMAIL = 'TailorSpace <orders@tailorspace.com>' // Update with your verified domain
const REPLY_TO = 'support@tailorspace.com' // Update with your support email
